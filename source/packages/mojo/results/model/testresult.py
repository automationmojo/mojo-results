...
class TestResult(ResultNode):
    ...
    """
    def __init__(self, inst_id: str, name: str, monikers: List[str], pivots: Dict[str, Any], result_code: ResultCode = ResultCode.UNSET,
        ...
        """
        super().__init__(inst_id, name, ResultType.TEST, result_code=result_code, parent_inst=parent_inst)
